...
locales = {
    "ar": {
        "commented": {
            ...
            "body": "انقر لعرضه على talk.future-rcrc.com"
        }
    },
    "en": {
        "commented": {
            "title": "New comment on your conversation",
            "body": "Tap to view on talk.future-rcrc.com"
        }
    },
    "es": {
        "commented": {
            "title": "Nuevo comentario en tu conversación",
            "body": "Clic para ver en talk.future-rcrc.com"
        }
    },
    "fr": {
        "commented": {
            "title": "Nouveau commentaire sur votre conversation",
            "body": "Appuyez pour afficher sur talk.future-rcrc.com"
        }
    }
}
